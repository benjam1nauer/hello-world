...
if (BLA_VENDOR MATCHES "Intel*" OR BLA_VENDOR STREQUAL "All")
 ...
 if (_LANGUAGES_ MATCHES C OR _LANGUAGES_ MATCHES CXX)
  ...
  if(BLA_F95)
    ...
    SGEMM
    ""
    "mkl_c;mkl_intel_thread;mkl_core;libguide40"
    ""
    )
    endif()
  endif(BLA_F95)
  ...
  if(BLA_F95)
    ...
    sgemm
    ""
    "mkl_blas95_lp64;mkl_intel_lp64;mkl_intel_thread;mkl_core;libiomp5md"
    ""
    )
    endif()
	if(NOT BLAS95_LIBRARIES)
    ...
    sgemm
    ""
    "mkl_blas95_lp64;mkl_intel_lp64;mkl_intel_thread;mkl_core;libguide40"
    ""
    )	
	endif()	
  else(BLA_F95)
    ...
    SGEMM
    ""
    "mkl;mkl_intel_thread;mkl_core;libguide40"
    ""
    )
    endif()
  endif(BLA_F95)    
